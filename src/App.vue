  ...
  data: () => ({
    ...
    items: [
      ...
      {title: 'External Support', icon: 'mdi-view-dashboard', path: '/externalsupport'},
        {title: '-------------------', icon: 'mdi-view-dashboard', path: '/sqqs'},
      {title: 'External Support Feedback', icon: 'mdi-view-dashboard', path: '/externalsupportfeedback'},
      {title: '-------------------', icon: 'mdi-view-dashboard', path: '/sqqdsdss'},
      {title: 'Home', icon: 'mdi-view-dashboard', path: '/homecoach'},
      {title: 'Chat', icon: 'mdi-view-dashboard', path: '/chatcoach'}
    ],
    right: null,
  }),
};
