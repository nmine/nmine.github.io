<template>
    <v-stepper v-model="e1">
        <v-stepper-header>
            ...
            <v-stepper-step step="4" editable>Session Selection</v-stepper-step>
        ...
        <v-stepper-items>
            <v-stepper-content step="1">
                <v-form>
                    <v-slider
                            v-model="value"
                            :rules="rules"
                            label="Number of coach for the project"
                            step="10"
                            thumb-label="always"
                            ticks
                            class="pt-10"
            ...
            <v-stepper-content step="4">
                <v-row>
                    <v-col cols="12" sm="3">
                        Please select Begin date and en date for the project
                    </v-col>
                    <v-col
                            cols="12"
                            sm="9"
                ...
                <v-row>
                    <v-slider
                            v-model="value"
                            :rules="rules"
                            label="NNumber of credit per trainee"
                            step="10"
                            thumb-label="always"
                            ticks
                            class="pt-10"
            ...
            <v-stepper-content step="5">
                <v-row justify="center">
                    <v-expansion-panels accordion>
                        <v-expansion-panel>
                            <v-expansion-panel-header>Trainee</v-expansion-panel-header>
                ...
                <v-row justify="center">
                    <v-expansion-panels accordion>
                        <v-expansion-panel>
                            <v-expansion-panel-header>Sponsor</v-expansion-panel-header>
                            <v-expansion-panel-content>
                                <v-data-table
                                        :headers="headers"
                                        :items="desserts"
